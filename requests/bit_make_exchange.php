      ...
      <table class="table table-striped">
        ...
        <tr>
          <td><span class="pull-left"><?php echo $lang['our']; ?>
              <?php echo gatewayinfo($row['gateway_send'],"name"); ?> <?php echo $lang['details']; ?></span></td>
          <td><span
              class="pull-right"><?php echo gatewayinfo($row['gateway_send'],"a_field_1"); ?><br /><?php echo gatewayinfo($row['gateway_send'],"a_field_2"); ?></span>
          </td>
        </tr>
        <tr>
          <td><span class="pull-left"><?php echo $lang['enter_payment_amount']; ?></span></td>
  ...
  <div class="col-md-12">
    ...
    <form id="bit_confirm_transaction">
      <table class="table table-striped">
        ...
        <tr>
          <td><span class="pull-left"><?php echo $lang['our']; ?>
              <?php echo gatewayinfo($row['gateway_send'],"name"); ?> <?php echo $lang['address']; ?></span></td>
  ...
  <div class="col-md-12">
    ...
    <form id="bit_confirm_transaction">
      <table class="table table-striped">
        ...
        <tr>
          <td><span class="pull-left"><?php echo $lang['our']; ?>
              <?php echo gatewayinfo($row['gateway_send'],"name"); ?> account</span></td>
          <td><span class="pull-right"><?php echo gatewayinfo($row['gateway_send'],"a_field_1"); ?></span></td>
        </tr>
        <tr>
          <td><span class="pull-left"><?php echo $lang['enter_payment_amount']; ?></span></td>
