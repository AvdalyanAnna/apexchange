    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            if (isset($_POST['btn_add'])) {
                ...
                if (empty($gateway_from) or empty($gateway_to) or empty($rate_from) or empty($rate_to)) {
                    echo error("All fields are required.");
                } elseif ($check->num_rows > 0) {
                    echo error("This exchange rate already exists.");
                } elseif (!is_numeric($rate_from)) {
                    echo error("Please enter rate from with numbers.");
                } elseif (!is_numeric($rate_to)) {
                    echo error("Please enter rate to with numbers.");
                } else {
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="rate_from" placeholder="1"
                               aria-describedby="basic-addon1">
                        <span class="input-group-addon" id="basic-addon1">=&nbsp;&nbsp; Rate to</span>
                        <input type="text" class="form-control" name="rate_to" placeholder="0.95"
                               aria-describedby="basic-addon1">
                    </div>
                </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            if (isset($_POST['btn_save'])) {
                ...
                $rate_from = protect($_POST['rate_from']);
                $rate_to = protect($_POST['rate_to']);
                if (empty($rate_from) or empty($rate_to)) {
                    echo error("All fields are required.");
                } elseif (!is_numeric($rate_from)) {
                    echo error("Please enter rate from with numbers.");
                } elseif (!is_numeric($rate_to)) {
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="rate_from"
                               value="<?php echo $row['rate_from']; ?>" placeholder="1" aria-describedby="basic-addon1">
                        <span class="input-group-addon" id="basic-addon1">=&nbsp;&nbsp; Rate to</span>
                        <input type="text" class="form-control" name="rate_to" value="<?php echo $row['rate_to']; ?>"
                               placeholder="0.95" aria-describedby="basic-addon1">
                    </div>
                </div>
                ...
                if ($query->num_rows > 0) {
                    while ($row = $query->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['rate_from']; ?> <?php echo gatewayinfo($row['gateway_from'], "currency"); ?>
                                = <?php echo $row['rate_to']; ?> <?php echo gatewayinfo($row['gateway_to'], "currency"); ?></td>
                            <td>
                                <a href="./?a=rates&b=edit&id=<?php echo $row['id']; ?>" title="Edit"><i
                                            class="fa fa-pencil"></i></a>
                                <a href="./?a=rates&b=delete&id=<?php echo $row['id']; ?>" title="Delete"><i
