...
<footer id="footer" class="clearfix">
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="footer-list">
                        <li><a href="<?php echo $settings['url']; ?>faq">
                                <?php echo $lang['faq']; ?></a></li>
                        <li><a href="
                                <?php echo $settings['url']; ?>page/terms-of-services">
                                <?php echo $lang['terms_of_services']; ?></a></li>
                        <li><a href="
                                <?php echo $settings['url']; ?>page/privacy-policy">
                                <?php echo $lang['privacy_policy']; ?></a></li>
                        <li><a href="<?php echo $settings['url']; ?>page/about">
                ...
                <!--							<ul>-->
                <!--								<li><a href="--><?php //echo $settings['url']; ?><!--">-->
                <?php //echo $lang['exchange']; ?><!--</a></li>-->
                <!--								<li><a href="-->
                <?php //echo $settings['url']; ?><!--testimonials">-->
                <?php //echo $lang['testimonials']; ?><!--</a></li>-->
                <!--								<li><a href="--><?php //echo $settings['url']; ?><!--affiliate">-->
                <?php //echo $lang['affiliate']; ?><!--</a></li>-->
                <!--							</ul>-->
                <!--						</div>-->
                <!--					</div>-->
                <!-- footer-widget -->
                ...
                <!--								<li><a href="--><?php //echo $settings['url']; ?><!--page/about">-->
                <?php //echo $lang['about']; ?><!--</a></li>-->
                <!--								<li><a href="--><?php //echo $settings['url']; ?><!--contact">-->
    ...
    <!--			<div class="container">-->
    <!--				<p>Copyright &copy; 2016 by CMS v2.0</p>-->
    <!--			</div>-->
    <!--		</div>-->
    <!-- footer-bottom -->
</footer><!-- footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-info">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember_me"
                                               value="yes"> <?php echo $lang['remember_me']; ?>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <button type="button" class="btn btn-danger pull-right btn-lg"
                                        onclick="bit_login();"><?php echo $lang['btn_login']; ?></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <center>
                        <p><?php echo $lang['with_entry']; ?> <a
                                    href="<?php echo $settings['url']; ?>page/terms-of-services"><?php echo $lang['terms_of_service']; ?></a> <?php echo $lang['and']; ?>
    ...
    <div class="modal fade" id="register" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-info">
                ...
                <div class="modal-body modal-spa">
                    ...
                    <form id="register_form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-danger pull-right btn-lg"
                                        onclick="bit_register();"><?php echo $lang['btn_register']; ?></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <center>
                        <p><?php echo $lang['with_registering']; ?> <a
                                    href="<?php echo $settings['url']; ?>page/terms-of-services"><?php echo $lang['terms_of_services']; ?></a> <?php echo $lang['and']; ?>
                            <a href="<?php echo $settings['url']; ?>page/privacy-policy"><?php echo $lang['privacy_policy']; ?></a>
                        </p>
                    </center>
                </div>
...
<script src="//code.jivo.ru/widget/xotXcpAAaP" async></script>
</body>
</html>